...
#work(
  ...
  dates: dates-helper(start-date: "Feb 2025", end-date: "2025-05-15"),
  // location: "Remote, India",
)
- Developed backend modules & RESTful APIs; authored comprehensive technical documentation for 5+ features.
...
- Engineered Python scripts for automated vulnerability scanning , achieving a 40% reduction in system vulnerabilities.
...
#project(
  ...
  // url: "github.com/itsanubhav009/recommendation-engine",
)
...
#project(
  ...
  // url: "github.com/itsanubhav009/devops-pipeline-project",
)
...
- Leveraged Terraform for IaC on AWS ; integrated Prometheus/Grafana, reducing incident response by 35%.
...
- Engineered a C++ Mail Server for 50+ concurrent users using multi-threading & SMTP/POP3 protocols.
