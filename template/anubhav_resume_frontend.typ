...
- *Languages*: JavaScript/TypeScript, HTML/CSS, Python, Java, SQL, Go
- *Frontend & Web Tech*: React, Next.js, Chart.js, Tailwind CSS; (Node.js, Django, FastAPI backend familiarity)
- *Databases*: MySQL, PostgreSQL, MongoDB, Redis
- *DevOps & Cloud*: Docker, Kubernetes, Jenkins, AWS (EC2, S3), GCP, Azure
- *Developer Tools*: Git & GitHub, Linux/Unix Shell, Postman, Browser DevTools
- *Core Concepts*: Data Structures & Algorithms, OOP, System Design, RESTful APIs, UI/UX Principles
...
- Developed dynamic, client-rendered Next.js dashboard visualizing data from 3+ REST API sources.
- Designed an intuitive, responsive UI with Chart.js presenting 5+ key metrics, enhancing user experience.
...
- *Tech*: React, Python, FastAPI, Docker, K8s, AWS, Kafka, Jenkins
- Built a responsive React-based admin dashboard for managing recommendation rules and viewing analytics.
- Contributed to backend APIs (Python/FastAPI) & CI/CD pipeline; system handled 1000+RPM.
...
- Developed the React frontend for a legal platform, connecting clients & lawyers with 4 core features.
- Implemented real-time chat UI (Socket.io) & JWT for secure, responsive user interactions.
...
- Project: Innovative Legal Platform (Frontend Prototyping); leveraged Agile for 40% higher project completion.